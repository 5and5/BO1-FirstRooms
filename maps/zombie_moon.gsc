...
moon_zone_init()
{
	...
	// mp5
	zone_init( "enter_forest_east_zone");
	enable_zone( "enter_forest_east_zone");

	//labs
    zone_init( "generator_exit_east_zone");
	enable_zone( "generator_exit_east_zone");
...
bypass_nml()
{
	...
	level thread zombie_moon_gravity_init();
