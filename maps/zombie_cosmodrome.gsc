...
cosmodrome_zone_init()
{
	...
	// m16
	zone_init( "north_catwalk_zone3");
	enable_zone( "north_catwalk_zone3");


	// steak out
	//zone_init( "power_building");
	//enable_zone( "power_building");
	//zone_init( "base_entry_zone2");
	//enable_zone( "base_entry_zone2");
